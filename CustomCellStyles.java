public enum CustomCellStyles {
    ...
    public static CustomCellStyles sigilToStyle(String sigil, boolean header) {
        switch (sigil.charAt(0)) {
            case '*': return header ? HEADER_STAR : STAR;
            case 'D': return header ? HEADER_GREEN : GREEN;
            case 'E': return header ? HEADER_GREY : GREY;
            case 'M': return header ? HEADER_YELLOW : YELLOW;
            case 'N': return header ? HEADER_RED : RED;
