...
public class SpreadsheetCreator {
    public static void createSpreadsheet(File saveLoc, TalosProgress options) {
        ...
        if (options.getVar("Randomizer_UnlockItems") == 1) {
            pickedOptions += "/Unlock All Items";
        }
        if (options.getVar("Randomizer_ShowAll") == 1) {
    ...
    private static String getSigilType(TalosProgress progress, String marker) {
    ...
    private static ArrayList<String> getWorldMarkers(TalosProgress progress, World w) {
    ...
    private static ArrayList<String> removeHiddenScavengerSigils(TalosProgress progress, ArrayList<String> markers) {
    ...
    private static World[] getWorldOrder(TalosProgress progress) {
        /*
          Worlds (1-Indexed):
